...
const redPieceImg = "red_piece.png";
const bluePieceImg = "blue_piece.png";
const yellowPieceImg = "yellow_piece.png";
const greenPieceImg = "green_piece.png";
...
socket.on("rollDice", (data, turn) => {
  ...
  document.getElementById("dice").src = `dice${data.num}.png`;
  drawPins();
